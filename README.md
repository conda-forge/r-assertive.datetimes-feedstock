About r-assertive.datetimes-feedstock
=====================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-assertive.datetimes-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=970&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-assertive.datetimes-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-assertive.datetimes` can be installed with `conda`:
...
```
mamba install r-assertive.datetimes
```

It is possible to list all of the versions of `r-assertive.datetimes` available on your platform with `conda`:
...
```
mamba search r-assertive.datetimes --channel conda-forge
```
...
mamba repoquery search r-assertive.datetimes --channel conda-forge

# List packages depending on `r-assertive.datetimes`:
mamba repoquery whoneeds r-assertive.datetimes --channel conda-forge

# List dependencies of `r-assertive.datetimes`:
mamba repoquery depends r-assertive.datetimes --channel conda-forge
```
